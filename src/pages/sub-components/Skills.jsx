...
const Skills = () => {
  ...
  return (
    <div className='w-full flex flex-col gap-8 sm:gap-12 '>
      <h1 className='w-fit overflow-x-hidden text-[2rem] sm:text-[2.75rem] md:text-[3rem] lg:text-[3.8rem] tracking-[2px] mb-4 mx-auto text-tubeLight-effect decent_text'>SKILLS</h1>
