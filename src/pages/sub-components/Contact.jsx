  ...
  return (
    <div className="overflow-x-hidden">
      <div className="relative mb-12">
        <h1
          className="hidden sm:flex gap-4 items-center text-[1.75rem] sm:text-[2rem] md:text-[2.5rem] lg:text-[3rem] leading-[56px] md:leading-[67px] lg:leading-[90px] tracking-[15px] mx-auto w-fit font-extrabold "
      ...
      <form onSubmit={sendMessageHandler} className="flex flex-col gap-6">
